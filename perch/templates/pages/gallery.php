            ...
            ?>
                <div class="c-albums">
                    ...
                    for ($i = 0; $i < count($albums); $i++) {
                        $albumSlug = $albums[$i]["albumSlug"];
                        $albumTitle = $albums[$i]["albumTitle"];
                        $imageUrl = perch_gallery_album($albumSlug, ["skip-template" => true], true)[0]["small"];
                    ?>

                        <a class="c-album c-choose-camp__camp" style="background-image: url(<?= $imageUrl ?>)" href="/gallery/index.php?s=<?= $albumSlug ?>">
                            <div class="c-choose-camp__title-content">
                                ...
                                <div class="c-choose-camp__title-wrapper">
                                    <h3 class="c-choose-camp__title"><?= $albumTitle ?></h3>
                                </div>
                            </div>
                        </a>
